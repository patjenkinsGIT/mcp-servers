...
DEADLINES = [
    ...
    },
    {
        ...
        "date": "2026-06-30",
        "title": "Microsoft Secure Boot Certificate Expiration",
        "description": "Original 2011 Secure Boot certificates begin expiring. Microsoft rolling out replacement certificates via Windows Update. Devices that miss the update continue to boot but miss future boot-level security mitigations.",
        "source": "microsoft",
        "category": "platform",
        "isMajor": True,
        "impact": "Enterprise device fleets need firmware-level certificate refresh"
    },
    {
